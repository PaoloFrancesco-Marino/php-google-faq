    ...
    <main>
        <div class="contanier">
            <div class="faq_content">
                <?php foreach ($google_faq as $key => $data) { ?>
                    <h2> <?php echo $key ?></h2>
